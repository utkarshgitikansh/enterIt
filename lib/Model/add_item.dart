...
//
//          setState(() {
//            old_count = old_count + ds.data.values.elementAt(ds.data.keys.toList().indexOf(_item.toLowerCase())) ;
//          });
//
//          exitCode;
//        }
...
////             data.data.values.toList().indexOf(_item) == _count
        ?
//     print('old data')
//    Firestore.instance.collection('inventory').document(_inventory.toLowerCase())
//        .updateData({ _item.toLowerCase() : old_count + _count })
//
//        :
    //       print('new data'),
    {
